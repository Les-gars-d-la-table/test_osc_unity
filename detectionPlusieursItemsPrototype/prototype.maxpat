...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1280.0, 857.0, 138.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1333.5, 800.0, 76.0, 22.0 ],
					"text" : "/slice5 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1109.0, 795.0, 138.0, 22.0 ],
					"text" : "udpsend 127.0.0.1 7002"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1162.5, 738.0, 76.0, 22.0 ],
					"text" : "/slice4 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 942.0, 757.0, 138.0, 22.0 ],
					"text" : "udpsend 127.0.0.1 7002"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 995.5, 700.0, 76.0, 22.0 ],
					"text" : "/slice3 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 790.0, 639.0, 138.0, 22.0 ],
					"text" : "udpsend 127.0.0.1 7002"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 843.5, 582.0, 76.0, 22.0 ],
					"text" : "/slice2 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 670.0, 516.0, 138.0, 22.0 ],
					"text" : "udpsend 127.0.0.1 7002"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 723.5, 459.0, 76.0, 22.0 ],
					"text" : "/slice1 $1 $2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 443.5, 376.0, 138.0, 22.0 ],
					"text" : "udpsend 127.0.0.1 7002"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 594.0, 408.789474010467529, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 258.0, 332.0, 125.0, 22.0 ],
...
, 			{
		...
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Desktop/detectionPlusieursItemsPrototype",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
